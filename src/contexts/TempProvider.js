...
class ProductProvider extends Component {
  ...
  componentDidMount() {
    let categories = ['Q9Zt5ZGNukNabpTzvb3C','mJCDzZg83oIMi5yFXSaR', 'Opfy0qOkTz4ze5FPlhZb' , 'pBooSKpnX2SPhLz7CFpf'];
    this.fetchProducts(categories);
  }
  ...
  fetchProducts = async ( categories )=>{
    ...
    let query = productsRef.where('category_id', 'in', categories)
    let products = [];
